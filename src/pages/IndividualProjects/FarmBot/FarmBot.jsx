    ...
    <>
      <PageLayout>
        <Container>
          ...
          <img src='/src/images/FarmBotPhotos/farmbot-Lacy.jpg' alt='Farm Bot Photo with Lacy' className='farmbot-imgs'/>
          <img src='src/images/FarmBotPhotos/farmbot-side-view.jpg' alt='Farm Bot Photo' className='farmbot-imgs'/>
          <img src='src/images/FarmBotPhotos/farmbot-verticle-view.jpg' alt='Farm Bot Photo' className='farmbot-imgs'/>
        </Container>
      </PageLayout>
    </>
  )
