  ...
  return (
    <PageLayout>
      ...
      <Container style={{textAlign: 'end', paddingBottom: '10px'}}>
        <Link to='/Team'>
          <Button style={buttonStyle} type='submit' value='submit' bsPrefix='btn btn-slide-animation btn-slide-animation-lupine'>View our staff!  <FaArrowRight size={22} /></Button>
        </Link>
      </Container>
    </PageLayout>
  )
